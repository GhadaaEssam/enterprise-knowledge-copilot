# Source: https://engineering.hmn.md/how-we-work/style/react/

# React

React project style should follow the normal [JavaScript style guide](/standards/style/js/), with the addition of several React-specific rules. Much of the below is based on [Khan Academy’s style guide](https://href.li/?https://github.com/Khan/style-guides/blob/master/style/react.md) and various other industry standards.
...
### Wrap multi-line JSX in parentheses [#](#wrap-multi-line-jsx-in-parentheses)
...
### Use semantic HTML5 [#](#use-semantic-html5)

Although it is tempting to add all functionality to DIVs, keep in mind that the HTML5 you are writing with React must be [semantically meaningful and validating](/standards/style/markup/).
...
### Use ES6 class components [#](#use-es6-class-components)
...
### Name event handlers `onEventName` [#](#name-event-handlers-oneventname)
...
#### Colocate JavaScript Unit Tests [#](#colocate-javascript-unit-tests)
...
### Prefer [props to state](https://href.li/?https://react.dev/learn/sharing-state-between-components) [#](#prefer-props-to-state)
...
### Use [propTypes](https://href.li/?https://github.com/facebook/prop-types) [#](#use-proptypes)
...
### Do not store state in the DOM [#](#do-not-store-state-in-the-dom)
...
Accessed Thu, 14 Dec 2017 07:03:02 +0000 from `https://engineering.hmn.md/standards/style/react/`
