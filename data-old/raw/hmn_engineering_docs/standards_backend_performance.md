# Source: https://engineering.hmn.md/standards/backend/performance/
...
## Cache Queries and Requests [#](#cache-queries-and-requests)
...
## Avoid Writes on Page Views [#](#avoid-writes-on-page-views)
...
## Unperformant Functions [#](#unperformant-functions)
...
Accessed Mon, 26 Feb 2018 10:02:33 +0000 from `https://engineering.hmn.md/standards/backend/performance/`
