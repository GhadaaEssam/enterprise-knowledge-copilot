# Source: https://engineering.hmn.md/how-we-work/process/architecture/
...
## Sites and Networks [#](#sites-and-networks)
...
### Third Party Data Handling [#](#third-party-data-handling)
...
### Classifying Content with Taxonomies [#](#classifying-content-with-taxonomies)
...
### Flat vs. Hierarchical Taxonomies [#](#flat-vs-hierarchical-taxonomies)
...
### Open, Restricted, Locked, and Hidden Taxonomies [#](#open-restricted-locked-and-hidden-taxonomies)
...
## Object to Object Relationships [#](#object-to-object-relationships)
...
### Post to Post Relationships for Non-Hierarchical Post Types [#](#post-to-post-relationships-for-non-hierarchical-post-types)
...
The *New Post* and *Edit Post* screens in the admin will handle assigning posts to a parent post automatically in the database, as long as a `parent_id` field is sent along in the `$_POST` data when the post is saved. This can be achieved by naming a specific field in your custom UI accordingly.
...
### One to One Relationships for Terms and Posts [#](#one-to-one-relationships-for-terms-and-posts)
...
### One to Many Relationships for Posts [#](#one-to-many-relationships-for-posts)
...
## Customising Built-In Archives [#](#customising-built-in-archives)
...
## Meta Data Handling [#](#meta-data-handling)
...
### Key Query Limitations [#](#key-query-limitations)
...
### Value Query Limitations [#](#value-query-limitations)
...
### Handling of Different Data Types [#](#handling-of-different-data-types)
...
Accessed Mon, 26 Feb 2018 10:02:30 +0000 from `https://engineering.hmn.md/how-we-work/process/architecture/`
