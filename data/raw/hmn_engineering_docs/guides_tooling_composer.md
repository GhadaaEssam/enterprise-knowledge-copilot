# Source: https://engineering.hmn.md/guides/tooling/composer/
...
#### Ensuring Completion of Tickets [#](#ensuring-completion-of-tickets)
...
#### Temporary Branch Targeting [#](#temporary-branch-targeting)
...
#### Version Targeting with Patch Updates [#](#version-targeting-with-patch-updates)
...
## Premium plugins / Closed source [#](#premium-plugins-closed-source)
...
## packagist.hmn.md [#](#packagist-hmn-md)
...
![](https://hmn.md/tachyon/sites/82/2026/07/Screenshot-2024-09-20-at-18.11.12-scaled.png?fit=1024%2C648)

* Go to the Add New Plugin page at <https://packagist.hmn.md/wp-admin/plugin-install.php>
* Click “Upload Plugin” next to the page heading
* Upload the plugin zip file

### Configure SatisPress [#](#configure-satispress)

![](https://hmn.md/tachyon/sites/82/2026/07/Screenshot-2024-09-20-at-18.16.54-scaled.png?fit=1024%2C1024)

* With the plugin uploaded go to <https://packagist.hmn.md/wp-admin/options-general.php?page=satispress>
...
### Installing from packagist.hmn.md [#](#installing-from-packagist-hmn-md)
...
Accessed Wed, 08 Jul 2026 15:04:06 +0000 from `https://engineering.hmn.md/guides/tooling/composer/`
